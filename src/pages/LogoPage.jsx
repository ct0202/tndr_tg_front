        ...
        try {
          axios.post("/auth/getUserById", {userId: userId} ).then(async (res) => {
            if(res.status == 200){
              ...
              // Кэширование данных пользователей для страниц LikesPage и FindPage
              console.log('🚀 Кэширую данные пользователей...');
              await pageCache.cacheUsersData(userId, res.data);
